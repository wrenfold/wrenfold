...
impl Gradient for Problem {
    ...
    fn gradient(&self, p: &Self::Param) -> Result<Self::Gradient, Error> {
        ...
        // NOTE: we convert back to an Array1 here because argmin doesn't seem to have
        // traits implemented for nalgebra types when using trust region methods
...
impl Hessian for Problem {
    ...
    fn hessian(&self, p: &Self::Param) -> Result<Self::Hessian, Error> {
        ...
        // NOTE: we convert back to an Array2 here because argmin doesn't seem to have
        // traits implemented for nalgebra types when using trust region methods
        Ok(
