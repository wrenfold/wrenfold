  ...
  T5: wrenfold_traits::OutputSpan2D<6, 6, ValueType = f64>,
{
  ...
  let v00114: f64;
  if v00043 {
    let v01474: f64 = v00044 * (v00042).sqrt();
    v00052 = v01454 * v01474;
    v00114 = v01474 * (v00950 * v01396);
  } else {
    let v02181: f64 = (0i64) as f64;
    v00052 = v02181;
    v00114 = v02181;
  }
  ...
  let v00971: f64 = v00036 * (v00649 * v01670 + v00019 * v01700);
  let v01196: f64 = v00056 + v00176 * v01774;
  let v00539: f64 = v00001 * v01752;
  let v00533: f64 = v00031 * (v00080 + -v00030);
  let v00076: f64 = v00062 * v01670;
  let v00003: f64 = u;
  let v00946: f64 = v00056 * (v00008 * v00176) + v01711;
  let v01786: f64 = -v00988;
  let v00972: f64 = (v00114 + v00124) * v01395 + v00971;
  let v01663: f64 = v01196 * v01393;
  let v00540: f64 = v00003 + (v00000 * ((1i64) as f64 / v00013)).tanh() * v01758 + v00076 + v00533 + (v00052 + v00072) * v01395 + v00539;
  let v00593: f64 = (v00062 * v01779 + v01397 * v01555) * v01388;
  ...
  let v00594: f64 = v00136 * v01395 + v00593;
  let v01664: f64 = v01388 * v01389;
  let v01675: f64 = v00946 * v01772;
  let v01688: f64 = v01193 * v01389;
  let v01666: f64 = v00036 * v01388;
  let v01725: f64 = v01199 * v01393;
  let v01676: f64 = v00988 * v01771;
  let v00943: f64 = (v00036 * v01204) * v01664;
  let v00101: f64 = (1i64) as f64 / v00943;
  let v01219: f64 = (v00036 * v00594) * v01725 + (v00540 * v01663 + v00972 * v01786) * v01666;
  let v01225: f64 = v00057 * (v00540 * v01674 + v00937 * v00972) + v00594 * v01676;
  let v01439: f64 = v00036 * v00101;
  let v01667: f64 = v00101 * v01388;
  let v01689: f64 = (v00540 * v01688 + v00972 * v01675 + v00594 * v01663) * v01388;
  if let Some(J_x) = J_x {
    let v00189: i64;
    if v00029 {
      v00189 = 1i64;
    ...
    let v00412: f64;
    if v00043 {
      let v02162: f64 = (v00042).sqrt();
      let v00231: f64 = (1i64) as f64 / v02162;
      let v01547: f64 = v00231 * v00950;
      let v01696: f64 = v01400 * v01454;
      let v01015: f64 = v00040 + v00520;
      let v01626: f64 = (3i64) as f64 * v02162;
      let v02148: f64 = v00044 * v02162;
      v00239 = v01015 * (v00950 * (v00226 * v00231) * v01699 + v02148) * (v00035 * (2i64) as f64) * v01771;
      ...
      v00412 = (v00950 * (v01400 * v01547) + v01114 * v02148) * v01702;
    } else {
      let v02134: f64 = (0i64) as f64;
      v00239 = v02134;
      v00270 = v02134;
      v00367 = v02134;
      v00381 = v02134;
    ...
    let v00434: f64;
    if v00067 {
      let v02132: f64 = (v00066).sqrt();
      let v00245: f64 = (1i64) as f64 / v02132;
      ...
      let v01458: f64 = (3i64) as f64 * v02132;
      let v02091: f64 = v00044 * v02132;
      let v01698: f64 = v01400 * v01465;
      let v01697: f64 = v01400 * v01464;
      let v01687: f64 = v00975 * v01400;
      v00253 = (v00958 * (v00226 * v00245) * v01699 + v02091) * ((2i64) as f64 * v01027) * v01771;
      v00276 = v00001 * (v00035 * v01458 + v01027 * v01759) * v01771;
      v00287 = (v01698 * -v01027 + v00649 * v02091) * v01389 * (v00001 * (2i64) as f64);
      v00320 = (v01697 * -v01078 + v00722 * v02091) * v01389 * v01467;
      v00335 = (v01402 * v01698 + v02091) * ((2i64) as f64 * v01078) * v01772;
      ...
      v00401 = (2i64) as f64 * (v01464 * v01687 + v00176 * v02091) * v01389;
      v00418 = (v00958 * v01697 + v01114 * v02091) * v01702;
      v00434 = v00057 * (v01465 * v01687 + (v00062 * v00062 + v01632) * v02091) * v01401;
    } else {
      let v02046: f64 = (0i64) as f64;
      v00253 = v02046;
      v00276 = v02046;
      v00287 = v02046;
      v00320 = v02046;
    ...
    let v02044: f64 = (1i64) as f64 / v00013;
    let v01417: f64 = v00038 * v01766;
    let v02032: f64 = (v00000 * v02044).tanh();
    let v01433: f64 = v00001 * v00001;
    let v01695: f64 = v01417 * v01771;
    let v01390: f64 = v00008 * v00036;
    let v02000: f64 = v00003 + v00076 + v00533 + v00539 + v01758 * v02032 + v01395 * (v00052 + v00072);
    ...
    let v01954: f64 = v00593 + v00136 * v01395;
    ...
    let v00772: f64 = ((1i64) as f64 + -v02032 * v02032) * v01758 * v02044 + (v00367 + v00373) * v01395;
    ...
    J_x.set(3, 1, (v00215 * v01238) * v01664 * v01665 * v01776 * (v01688 * v02000 + v01675 * v01980 + v01663 * v01954) + (v01229 * v01393 * v01683 + v00696 * v01677 + v00705 * v01678 + (v00649 * v01762 + v01012 * v01980 + v00946 * v01045) * v01784) * v01804);
    J_x.set(3, 2, v01268 * ((2i64) as f64 * v00215) * v01665 * v01665 * v01689 + (v01096 * v01678 + (v01256 * v01393) * v01865 + v00351 * v01677 + (v00722 * v01762 + v01074 * (v00008 * v01980) + v00746 * v00946) * v01784) * v01667);
    J_x.set(3, 3, (v00772 * v01761 + (v00358 * v01663 + v00773 * v01675) * v01395 * v01666) * v01858);
    J_x.set(3, 4, (v00788 * v01663 + v01675 * v01686 + v00799 * v01688) * (v01388 * (v00036 * v01858)));
    J_x.set(3, 5, (v01663 * v01681 + v00813 * v01675 + v00442 * v01688) * (v01388 * v01439));
    J_x.set(4, 0, (v01664 * v01685) * -v00946);
    J_x.set(4, 1, v01669 * v01765 * (v00057 * (v01674 * v02000 + v00937 * v01980) + v01676 * v01954) + ((v01134 * v01954 + v00705 * v00988) * v01665 + (v01045 * v01640 + (v01012 * v02000 + v00696 * v00946) * v01784) * v01388) * v01858);
    J_x.set(4, 2, ((v01148 * v01954 + v00988 * v01096) * v01665 + (v00746 * v01640 + (v01404 * (v00056 * v00062) * v01980 + v01074 * v01682 + v00351 * (v00036 * v00946)) * v01772) * v01388) * v01858 + (v01388 * v01388) * (v01225 * v01776) * v01763);
    J_x.set(4, 3, (v00057 * (v00772 * v01674 + v00937 * v01717) + v01676 * v01707) * v01804);
    J_x.set(4, 4, (v00057 * (v00799 * v01674 + v00937 * v01686) + v00788 * v01676) * v01804);
    J_x.set(4, 5, (v00057 * (v00813 * v00937 + v00442 * v01674) + v01676 * v01681) * v01804);
    J_x.set(5, 0, v01501 * v01678 * (v00643 * v01388));
    J_x.set(5, 1, (v01219 * v01776) * v01765 + (v00705 * v01679 + ((v01766 * v02000) * (v01229 * v01771) + v00696 * v01663) * v01666 + -((2i64) as f64 * (v00035 * v01766) * v01683 * v01695 + (v01134 * v01980 + v00988 * v01045) * v01666)) * v01858);
    J_x.set(5, 2, v01669 * v01763 * (v01725 * v01865 + v01666 * (v01663 * v02000 + v01786 * v01980)) + (v01096 * v01679 + (v01148 * v01980 + v00746 * v00988) * v01665 + (v01256 * (v01393 * v02000) + v00351 * v01663) * v01666) * v01858);
    J_x.set(5, 3, (v01678 * (v00772 * v01388) + (v01199 * (v00358 * v01393) + v00773 * v01388 * v01786) * (v00036 * v01395)) * v01858);
    J_x.set(5, 4, (v00788 * v01679 + (v01686 * v01786 + v00799 * v01663) * v01666) * v01858);
    J_x.set(5, 5, (v01679 * v01681 + (v00813 * v01786 + v00442 * v01663) * v01666) * v01858);
  }
