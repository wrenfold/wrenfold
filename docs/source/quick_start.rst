...
download and install ``wrenfold-0.2.2-cp310-cp310-macosx_11_0_arm64.whl``:

.. code:: bash

   pip install wrenfold-0.2.2-cp310-cp310-macosx_11_0_arm64.whl
...
.. code:: python
   ...
   import wrenfold
   print(wrenfold.__version__)  # prints: 0.2.2
