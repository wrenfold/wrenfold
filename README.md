...
* **Narrower scope**: wrenfold does not implement a numerical optimizer. Rather we aim to make it simple to integrate generated code into your project's existing preferred optimizer (see the [ceres_simple_bundle_adjuster](https://github.com/wrenfold/wrenfold/tree/main/examples/ceres_simple_bundle_adjuster), [gtsam_bal](https://github.com/wrenfold/wrenfold/tree/main/examples/gtsam_bal), or [pyceres](https://github.com/wrenfold/wrenfold/tree/main/examples/pyceres_examples) examples). It should be relatively straightforward to use wrenfold functions with GTSAM, Ceres, the SymForce optimizer, or your own custom implementation.
