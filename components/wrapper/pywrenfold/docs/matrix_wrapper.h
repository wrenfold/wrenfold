...
inline constexpr std::string_view matrix_expr_normalized = R"doc(
...
inline constexpr std::string_view matrix_expr_colwise_normalized = R"doc(
...
inline constexpr std::string_view matrix_expr_rowwise_normalized = R"doc(
