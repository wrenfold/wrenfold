...
class CppGenerator:
    def __init__(self, matrix_args: CppMatrixTypeBehavior = ...) -> None: ...
...
class CppMatrixTypeBehavior:
    __members__: ClassVar[dict] = ...  # read-only
    Eigen: ClassVar[CppMatrixTypeBehavior] = ...
    GenericSpan: ClassVar[CppMatrixTypeBehavior] = ...
    __entries: ClassVar[dict] = ...
    def __init__(self, value: int) -> None: ...
    def __eq__(self, other: object) -> bool: ...
    def __hash__(self) -> int: ...
...
class PythonGenerator:
    def __init__(self, target: PythonGeneratorTarget = ..., float_width: PythonGeneratorFloatWidth = ..., indentation: int = ..., use_output_arguments: bool = ...) -> None: ...
