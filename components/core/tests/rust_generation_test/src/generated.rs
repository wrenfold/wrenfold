  ...
  T2: wrenfold_traits::OutputSpan2D<9, 3, ValueType = f64>,
{
  ...
  if let Some(R_D_w) = R_D_w {
    ...
    if v0012 {
      ...
      let v0162: f64 = v0008 * v0128;
      let v0179: f64 = v0004 * v0128;
      ...
      let v0146: f64 = -v0145;
      let v0167: f64 = v0127 + v0163;
      let v0166: f64 = v0008 * v0132;
      let v0184: f64 = v0127 + v0180;
      let v0183: f64 = v0004 * v0132;
      ...
      let v0137: f64 = v0102 * v0103;
      let v0152: f64 = v0005 * v0007;
      let v0105: f64 = v0102 * v0104;
      let v0121: f64 = v0102 * v0120;
      let v0138: f64 = v0006 * v0137;
      let v0136: f64 = v0013 * v0028;
      let v0153: f64 = v0102 * v0152;
      let v0170: f64 = v0008 * v0137;
      let v0187: f64 = v0004 * v0137;
  ...
  T1: wrenfold_traits::OutputSpan2D<3, 1, ValueType = f64>,
{
  ...
  let v0113: f64 = v0073 * v0110;
  let v0112: f64 = v0057 * v0110;
  let v0111: f64 = v0087 * v0110;
  w.set(0, 0, v0111);
  w.set(1, 0, v0112);
  w.set(2, 0, v0113);
}
