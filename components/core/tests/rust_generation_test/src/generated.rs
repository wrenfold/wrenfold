  ...
  T3: wrenfold_traits::OutputSpan2D<2, 1, ValueType = f64>,
{
  ...
  let v001: f64 = theta;
  let v006: f64 = (v001).sin();
  let v005: f64 = v.get(1, 0);
  let v002: f64 = (v001).cos();
  let v000: f64 = v.get(0, 0);
  let v022: f64 = v005 * v006;
  let v011: f64 = v002 * v005;
  let v010: f64 = v000 * v006;
  let v025: f64 = -v022;
  let v003: f64 = v000 * v002;
  let v012: f64 = v010 + v011;
  let v009: f64 = v003 + v025;
  ...
  T2: wrenfold_traits::OutputSpan2D<9, 3, ValueType = f64>,
{
  ...
  let v0006: f64 = w.get(1, 0);
  let v0004: f64 = w.get(0, 0);
  let v0007: f64 = v0006 * v0006;
  let v0005: f64 = v0004 * v0004;
  let v0008: f64 = w.get(2, 0);
  let v0551: f64 = v0005 + v0007;
  let v0009: f64 = v0008 * v0008;
  let v0552: f64 = v0009 + v0551;
  let v0020: f64 = 0.25f64;
  let v0205: f64 = v0020 * v0552;
  let v0206: f64 = (1i64) as f64 + v0205;
  let v0015: f64 = 0.5f64;
  let v0011: f64 = (v0552).sqrt();
  let v0025: f64 = (v0206).sqrt();
  let v0017: f64 = v0011 * v0015;
  let v0026: f64 = (1i64) as f64 / v0025;
  let v0018: f64 = (v0017).sin();
  let v0014: f64 = (1i64) as f64 / v0011;
  let v0476: f64 = v0015 * v0026;
  let v0470: f64 = v0014 * v0018;
  let v0041: f64 = (v0017).cos();
  ...
  if let Some(R_D_w) = R_D_w {
    ...
    let v0137: f64;
    if v0012 {
      let v0529: f64 = v0011 * v0011;
      let v0530: f64 = v0011 * v0529;
      let v0067: f64 = (1i64) as f64 / v0530;
      let v0520: f64 = v0015 * v0041;
      let v0062: f64 = (1i64) as f64 / v0552;
      let v0557: f64 = -v0067;
      let v0527: f64 = v0062 * v0520;
      let v0247: f64 = v0018 * v0557;
      let v0262: f64 = v0007 * v0557;
      let v0248: f64 = v0247 + v0527;
      let v0263: f64 = v0014 + v0262;
      let v0111: f64 = -0.5f64;
      let v0479: f64 = v0004 * v0248;
      let v0487: f64 = v0008 * v0248;
      let v0264: f64 = v0018 * v0263;
      let v0092: f64 = v0007 * v0527;
      let v0273: f64 = v0009 * v0248;
      let v0495: f64 = v0111 * v0470;
      let v0282: f64 = v0005 * v0248;
      v0076 = v0006 * v0479;
      v0083 = v0008 * v0479;
      v0090 = v0006 * v0487;
      v0099 = v0092 + v0264;
      ...
      let v0531: f64 = v0025 * v0025;
      let v0532: f64 = v0025 * v0531;
      let v0074: f64 = (1i64) as f64 / v0532;
      let v0070: f64 = -0.125f64;
      let v0471: f64 = v0070 * v0074;
      let v0480: f64 = v0004 * v0471;
      let v0482: f64 = v0006 * v0471;
      let v0097: f64 = v0007 * v0471;
      let v0106: f64 = v0009 * v0471;
      let v0472: f64 = v0004 * v0074;
      let v0113: f64 = -0.25f64;
      let v0121: f64 = v0005 * v0471;
      let v0474: f64 = v0006 * v0074;
      let v0475: f64 = v0008 * v0074;
      v0076 = v0006 * v0480;
      v0083 = v0008 * v0480;
      v0090 = v0008 * v0482;
      v0099 = v0097 + v0476;
    ...
    let v0363: f64 = v0039 * v0137;
    let v0287: f64 = v0042 * v0083;
    let v0359: f64 = v0042 * v0076;
    let v0356: f64 = v0039 * v0129;
    let v0353: f64 = v0042 * v0123;
    let v0352: f64 = v0039 * v0115;
    let v0299: f64 = v0042 * v0108;
    let v0296: f64 = v0034 * v0137;
    let v0293: f64 = v0042 * v0090;
    let v0290: f64 = v0034 * v0129;
    let v0284: f64 = v0034 * v0115;
    let v0383: f64 = v0028 * v0137;
    let v0377: f64 = v0042 * v0099;
    let v0376: f64 = v0028 * v0129;
    let v0371: f64 = v0028 * v0115;
    let v0539: f64 = v0287 + v0363;
    let v0365: f64 = v0028 * v0108;
    let v0266: f64 = v0034 * v0090;
    let v0548: f64 = v0356 + v0359;
    let v0358: f64 = v0034 * v0099;
    let v0275: f64 = v0028 * v0090;
    let v0547: f64 = v0352 + v0353;
    let v0310: f64 = v0034 * v0076;
    let v0297: f64 = v0028 * v0083;
    let v0316: f64 = v0039 * v0108;
    let v0255: f64 = v0034 * v0083;
    let v0298: f64 = v0039 * v0090;
    let v0304: f64 = v0034 * v0123;
    let v0303: f64 = v0039 * v0083;
    let v0542: f64 = v0296 + v0299;
    let v0540: f64 = v0290 + v0293;
    let v0292: f64 = v0039 * v0099;
    let v0254: f64 = v0028 * v0076;
    let v0537: f64 = v0284 + v0287;
    let v0286: f64 = v0028 * v0123;
    let v0285: f64 = v0039 * v0076;
    let v0541: f64 = v0293 + v0383;
    let v0550: f64 = v0376 + v0377;
    let v0549: f64 = v0359 + v0371;
    let v0267: f64 = v0028 * v0099;
    let v0339: f64 = v0039 * v0123;
    let v0560: f64 = -v0539;
    let v0535: f64 = v0266 + v0365;
    let v0565: f64 = -v0548;
    let v0536: f64 = v0275 + v0358;
    let v0564: f64 = -v0547;
    let v0544: f64 = v0297 + v0310;
    let v0534: f64 = v0255 + v0316;
    let v0545: f64 = v0298 + v0310;
    let v0546: f64 = v0303 + v0304;
    let v0276: f64 = v0034 * v0108;
    let v0563: f64 = -v0542;
    let v0543: f64 = v0297 + v0298;
    let v0561: f64 = -v0540;
    let v0533: f64 = v0254 + v0292;
    let v0559: f64 = -v0537;
    let v0538: f64 = v0285 + v0286;
    let v0562: f64 = -v0541;
    let v0567: f64 = -v0550;
    let v0566: f64 = -v0549;
    let v0555: f64 = -(4i64) as f64;
    let v0414: f64 = v0275 + v0303;
    let v0410: f64 = v0267 + v0285;
    let v0406: f64 = v0254 + v0339;
    let v0468: f64 = v0535 + v0560;
    let v0463: f64 = v0536 + v0565;
    let v0458: f64 = v0544 + v0564;
    let v0384: f64 = v0534 + v0541;
    let v0378: f64 = v0545 + v0550;
    let v0372: f64 = v0546 + v0549;
    let v0366: f64 = v0535 + v0539;
    let v0360: f64 = v0536 + v0548;
    let v0354: f64 = v0544 + v0547;
    let v0348: f64 = v0276 + v0303;
    let v0344: f64 = v0266 + v0285;
    let v0340: f64 = v0255 + v0339;
    let v0453: f64 = v0543 + v0563;
    let v0448: f64 = v0533 + v0561;
    let v0443: f64 = v0538 + v0559;
    let v0438: f64 = v0534 + v0562;
    let v0433: f64 = v0545 + v0567;
    let v0428: f64 = v0546 + v0566;
    let v0300: f64 = v0542 + v0543;
    let v0294: f64 = v0533 + v0540;
    let v0288: f64 = v0537 + v0538;
    let v0277: f64 = v0275 + v0276;
    let v0268: f64 = v0266 + v0267;
    let v0256: f64 = v0254 + v0255;
    let v0415: f64 = v0414 * v0555;
    let v0411: f64 = v0410 * v0555;
    let v0407: f64 = v0406 * v0555;
    ...
    let v0349: f64 = v0348 * v0555;
    let v0345: f64 = v0344 * v0555;
    let v0341: f64 = v0340 * v0555;
    ...
    let v0278: f64 = v0277 * v0555;
    let v0269: f64 = v0268 * v0555;
    let v0257: f64 = v0256 * v0555;
    R_D_w.set(0, 0, v0257);
    R_D_w.set(0, 1, v0269);
    R_D_w.set(0, 2, v0278);
    R_D_w.set(1, 0, v0289);
  ...
  let v0225: f64 = v0039 * v0039;
  let v0207: f64 = v0028 * v0028;
  let v0558: f64 = -v0042;
  let v0208: f64 = v0034 * v0034;
  let v0556: f64 = -(2i64) as f64;
  let v0243: f64 = v0207 + v0225;
  let v0525: f64 = v0039 * v0042;
  let v0229: f64 = v0028 * v0034;
  let v0234: f64 = v0028 * v0558;
  let v0216: f64 = v0034 * v0039;
  let v0230: f64 = v0039 * v0558;
  let v0226: f64 = v0208 + v0225;
  let v0524: f64 = v0034 * v0042;
  let v0212: f64 = v0028 * v0039;
  let v0522: f64 = v0028 * v0042;
  let v0213: f64 = v0034 * v0558;
  let v0209: f64 = v0207 + v0208;
  let v0244: f64 = v0243 * v0556;
  let v0239: f64 = v0229 + v0525;
  let v0235: f64 = v0216 + v0234;
  let v0231: f64 = v0229 + v0230;
  let v0227: f64 = v0226 * v0556;
  let v0222: f64 = v0212 + v0524;
  let v0218: f64 = v0216 + v0522;
  let v0214: f64 = v0212 + v0213;
  let v0210: f64 = v0209 * v0556;
  ...
  T1: wrenfold_traits::OutputSpan2D<3, 1, ValueType = f64>,
{
  ...
  let v0119: f64 = v0002 + v0003;
  let v0121: f64 = v0003 + v0004;
  let v0120: f64 = v0002 + v0004;
  let v0132: f64 = -v0119;
  let v0124: f64 = v0004 + (1i64) as f64;
  let v0134: f64 = -v0121;
  let v0122: f64 = v0002 + (1i64) as f64;
  let v0133: f64 = -v0120;
  let v0123: f64 = v0003 + (1i64) as f64;
  let v0100: f64 = v0124 + v0132;
  let v0106: f64 = v0122 + v0134;
  let v0103: f64 = v0123 + v0133;
  let v0029: f64 = (v0100).sqrt();
  let v0042: f64 = (v0106).sqrt();
  let v0034: f64 = (v0103).sqrt();
  ...
  let v0125: f64 = v0004 + v0119;
  let v0108: f64 = v0008 * v0030;
  let v0109: f64 = v0008 * v0043;
  let v0037: bool = (v0002) < (v0004);
  let v0110: f64 = v0008 * v0055;
  let v0022: bool = (v0003) < (v0004);
  let v0021: bool = (v0002) < (v0003);
  let v0018: f64 = (v0017).sqrt();
  let v0014: f64 = v0009 + v0129;
  let v0050: f64 = v0039 + v0130;
  let v0065: f64 = v0024 + v0131;
  let v0007: bool = ((0i64) as f64) < (v0125);
  let v0047: f64;
  let v0062: f64;
  let v0074: f64;
  if v0007 {
    let v0019: f64 = (1i64) as f64 / v0018;
    let v0107: f64 = v0008 * v0019;
    v0047 = v0014 * v0107;
    v0062 = v0050 * v0107;
    v0074 = v0065 * v0107;
  } else {
    ...
    let v0031: f64 = v0025 * v0108;
    let v0053: f64 = v0008 * v0029;
    let v0067: f64 = v0058 * v0108;
    if v0021 {
      if v0022 {
        v0047 = v0031;
        v0062 = v0053;
  ...
  let v0127: f64 = v0048 + v0063;
  let v0075: f64 = v0074 * v0074;
  let v0128: f64 = v0075 + v0127;
  let v0077: f64 = (v0128).sqrt();
  ...
  if v0078 {
    ...
    let v0090: f64 = (v0077).atan2(v0089);
    let v0080: f64 = (1i64) as f64 / v0077;
    let v0117: f64 = v0080 * v0090;
    v0093 = (2i64) as f64 * v0117;
  } else {
    v0093 = (2i64) as f64;
  }
  let v0096: f64 = v0062 * v0093;
  let v0095: f64 = v0047 * v0093;
  let v0094: f64 = v0074 * v0093;
  w.set(0, 0, v0094);
  w.set(1, 0, v0095);
  w.set(2, 0, v0096);
}
