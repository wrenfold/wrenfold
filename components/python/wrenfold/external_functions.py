...
def declare_external_function(
    ...
    converted_args: list[
        tuple[str, type_info.ScalarType | type_info.MatrixType | type_info.CustomType]
    ] = []
...
def _invoke_external_function(func: PyExternalFunction, *args, **kwargs):
    ...
    for arg, (arg_name, arg_type) in zip(combined_args, arg_names_and_types, strict=True):
